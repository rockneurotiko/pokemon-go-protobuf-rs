...
impl ::protobuf::Message for CaptureAward {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.activity_type.is_empty() {
            my_size += ::protobuf::rt::vec_packed_enum_size(1, &self.activity_type);
        };
        if !self.xp.is_empty() {
            my_size += ::protobuf::rt::vec_packed_varint_size(2, &self.xp);
        };
        if !self.candy.is_empty() {
            my_size += ::protobuf::rt::vec_packed_varint_size(3, &self.candy);
        };
        if !self.stardust.is_empty() {
            my_size += ::protobuf::rt::vec_packed_varint_size(4, &self.stardust);
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if !self.activity_type.is_empty() {
            try!(os.write_tag(1, ::protobuf::wire_format::WireTypeLengthDelimited));
            // TODO: Data size is computed again, it should be cached
            try!(os.write_raw_varint32(::protobuf::rt::vec_packed_enum_data_size(&self.activity_type)));
        ...
        if !self.xp.is_empty() {
            try!(os.write_tag(2, ::protobuf::wire_format::WireTypeLengthDelimited));
            // TODO: Data size is computed again, it should be cached
            try!(os.write_raw_varint32(::protobuf::rt::vec_packed_varint_data_size(&self.xp)));
            for v in &self.xp {
        ...
        if !self.candy.is_empty() {
            ...
            // TODO: Data size is computed again, it should be cached
            try!(os.write_raw_varint32(::protobuf::rt::vec_packed_varint_data_size(&self.candy)));
            for v in &self.candy {
                try!(os.write_int32_no_tag(*v));
            };
        };
        if !self.stardust.is_empty() {
            ...
            // TODO: Data size is computed again, it should be cached
            try!(os.write_raw_varint32(::protobuf::rt::vec_packed_varint_data_size(&self.stardust)));
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    0x74, 0x79, 0x53, 0x63, 0x61, 0x6c, 0x65, 0x22, 0xa5, 0x01, 0x0a, 0x0c, 0x43, 0x61, 0x70, 0x74,
    0x75, 0x72, 0x65, 0x41, 0x77, 0x61, 0x72, 0x64, 0x12, 0x47, 0x0a, 0x0d, 0x61, 0x63, 0x74, 0x69,
    ...
    ,
    ...
    0x0a, 0x04, 0x04, 0x01, 0x02, 0x00, 0x12, 0x03, 0x0c, 0x08, 0x51, 0x0a, 0x0c, 0x0a, 0x05, 0x04,
    ...
    ,
    ...
    ,
];
